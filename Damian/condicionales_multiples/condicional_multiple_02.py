...
if(total_pagar>100 and total_pagar<1000):
    print("gracias por su preferencia")
if(total_pagar>=1000 and total_pagar<10000):
    print("oferta: ud. ha ganado un vale de 20% de descuento")
if(total_pagar>=10000):
    print("su proxima compra es gratis")
