...
if(tiempo_alcance>10 and tiempo_alcance<12):
    print("fue un alcance rapido")
if(tiempo_alcance>=12 and tiempo_alcance<15):
    print("alcance medio lento")
if(tiempo_alcance>=15):
    print("alcance demaciado lento, mejore la velocidad del movil 2")
